...
void Int_GPIO(void){
    ...
    GPIOIntClear(GPIO_PORTA_BASE, Status);         //Limpiar interrupción por PA6
...
void ECHO_interrup(void) {
    ...
    GPIOIntEnable(GPIO_PORTA_BASE, GPIO_INT_PIN_6);                            //Habilitar la interrupción por PA6 (Echo).
